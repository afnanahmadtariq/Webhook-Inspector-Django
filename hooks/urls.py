...
urlpatterns = [
    ...
    path('webhooks/endpoints/', views.WebhookEndpointListCreateView.as_view(), name='webhook_endpoints'),
    path('webhooks/endpoints/<uuid:uuid>/', views.WebhookEndpointDetailView.as_view(), name='webhook_endpoint_detail'),
    path('webhooks/capture/<uuid:hook_uuid>/', views.receive_webhook, name='webhook_capture'),
    ...
    path('webhooks/<uuid:hook_uuid>/analytics/', views.WebhookAnalyticsView.as_view(), name='webhook_analytics'),
    path('webhooks/<uuid:hook_uuid>/stats/', views.WebhookStatsView.as_view(), name='webhook_stats'),
    
    # Health check
    path('webhooks/health/', views.webhook_health_check, name='webhook_health'),
    
    # Schema management
    path('webhooks/schemas/', views.WebhookSchemaListCreateView.as_view(), name='webhook_schemas'),
    path('webhooks/schemas/<int:schema_id>/', views.WebhookSchemaDetailView.as_view(), name='webhook_schema_detail'),
    path('webhooks/schemas/<int:schema_id>/validate/', views.validate_webhook_schema, name='validate_schema'),
